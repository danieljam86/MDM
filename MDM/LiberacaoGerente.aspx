<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LiberacaoGerente.aspx.cs" Inherits="MDM.WebForm4" %>
...
<body style="height: 479px; width: 938px;">
    <form id="form1" runat="server">
        <div style="width: 936px">
            ...
            <asp:Label ID="lblPefil" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="Red"></asp:Label>
            <br />
            <br />
            <div>
...
&nbsp;<asp:Button ID="desmarcaTodos" runat="server" Font-Size="Smaller" Height="26px" OnClick="desmarcaTodos_Click" Text="Desmacar Todos" Width="120px" />
        ...
        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataKeyNames="id" ForeColor="Black" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" style="margin-right: 29px" Width="678px" OnRowCommand="GridView1_RowCommand1">
            <Columns>
                ...
                <asp:BoundField DataField="dataLibG1" HeaderText="Liberação Balancete" DataFormatString="{0:dd/MM/yyyy}" />
                ...
                <asp:BoundField DataField="dataLibG2" HeaderText="Liberação Pasta Digital" DataFormatString="{0:dd/MM/yyyy}" />
                <asp:BoundField DataField="prioridade" HeaderText="Prioridade" />
                <asp:BoundField DataField="pendenciaG" HeaderText="Pendencias do Setor" ApplyFormatInEditMode="True" ReadOnly="True" ValidateRequestMode="Enabled" />
        ...
        <asp:SqlDataSource ID="DataBase_mdm" runat="server" ConnectionString="<%$ ConnectionStrings:dados_mdmConnectionString %>" SelectCommand="SELECT [id_copia], [cod], [cond], [dataLibG1], [dataLibG2], [prioridade], [mes], [ano] FROM [Liberacao]"></asp:SqlDataSource>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br />
        <br />
        Selecione o mês e ano da liberação: <asp:TextBox ID="txmes" runat="server" Width="25px">7</asp:TextBox>
&nbsp;/
